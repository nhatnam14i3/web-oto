													...
													<?php  if (isset($item['type'])&&$item['type']=="image") { ?>
														<div class="form-group background-images">
															...
															<div class="bi-wrapper clearfix">
																...
																<div style="background:url('<?php echo $backgroundImageURL.$pattern;?>') no-repeat center center;" class="pull-left" data-image="<?php echo $backgroundImageURL.$pattern;?>" data-name="<?php echo $pattern; ?>" data-val="../../../images/bg/<?php echo $pattern; ?>">
